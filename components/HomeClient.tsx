  ...
  return (
    ...
    <div className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden" style={{ paddingTop: "3.5rem", isolation: "isolate" }}>
      ...
      >
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 pt-32 lg:pt-0">
          {/* Logo */}
          <motion.div
            ref={logoRef}
            initial={{ opacity: 0 }}
        ...
        <div className="flex flex-col items-center lg:items-end gap-8 flex-shrink-0 -mt-44 lg:mt-0">
          {/* Stats Counters */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
